// Shared Iris OAuth configuration.
//
// IRIS_REDIRECT_URI is read in two places — start/route.ts (passed to
...
export const IRIS_REDIRECT_URI = `${ADMIN_URL}/api/iris/oauth/callback`;
